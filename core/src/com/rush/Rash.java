...
public class Rash extends ApplicationAdapter {
    ...
    @Override
    public void create() {
        Gdx.app.log("", "gribochkov" + gribochkov + "");
        Gdx.app.log("", "derevov" + derevov + "");
        Gdx.app.log("", "ironovv" + ironovv + "");
        ...
        for (int i = 0; i < point.length; i += 1) {
            ...
            Gdx.app.log("", point[i][0] + ", " + point[i][1] + ", " + point[i][2] + ", " + point[i][3] + ", " + point[i][4]);
        }
        while (true) {
        ...
        persik = new Persik(100, 100, 10, 0);
        ...
        //hungrys[4] = 0;                      //ПРОВЕРКА НА МОНДРАЖ ГОЛОДА
        //hps[4] = 0;                          //ПРОВЕРКА НА МОНДРАЖ ХП
...
//                    Gdx.app.log("", "КОРОБКА! или ТОПОР!");
                    ...
                    for (int i = 0; i < 20; i += 1){
                        setP(persik.x, persik.y, persik.xz, 0.5f,0.5f,0.5f,1,1,0.1f,89,0.9f,random.nextInt(11)-5,random.nextInt(11)-5,2);
                    }
                    persik.sx += (screenX - (persik.x - cx)) / 10;
                    persik.sy += (h - screenY - (persik.y - cy)) / 10;
                    persik.sz += 15;
                    int index = -1;
                    for (int i = 0; i < 20; i += 1) {
                        if (dashs[i] == 0) {
                    ...
                    if (index != -1) {
                        dashs[index] = 3;
                        dashx[index] = persik.x;
                        dashy[index] = persik.y;
                        dashz[index] = persik.xz;
                    }
                }
                return false;
            }
            ...
            public boolean touchUp(int screenX, int screenY, int pointer, int button) {
                    ...
                    if (hit(screenX, h - screenY, build_kapkanx + 112, build_kapkany + 112, 50, 60)) {
                        ...
                        if (breven >= 2 & ironov >= 1) {
                            if (kapkand[chet_kapkan] == 0) {
                                kapkanx[chet_kapkan] = persik.x;
                                kapkany[chet_kapkan] = persik.y;
                ...
                for (int i = 0; i < derevox.length; i += 1) {
                    if (hit(screenX, h - screenY, toporx + 112, topory + 112, 50, 60)) {
                        ...
                        if (hit(persik.x, persik.y, derevox[i], derevoy[i], 50, 300)) {
                ...
                for (int i = 0; i < ironx.length; i += 1) {
                    if (hit(screenX, h - screenY, toporx + 112, topory + 112, 50, 60)) {
                        if (hit(persik.x, persik.y, ironx[i], irony[i], 50, 300)) {
                            for (int i2 = 0; i2 < 20; i2 += 1){
                ...
                if (hit(persik.x, persik.y, kraftx, krafty, 100, 300)) {
                    barx = 0;
                    bary = 0;
                    sypx_bar = 0;
                    sypy_bar = 0;
                ...
                for (int i = 0; i < ejx.length; i += 1) {
                    if (hit(screenX, h - screenY, w / ax + 112, h / ay + 112, 50, 60) & hit(persik.x, persik.y, ejx[i], ejy[i], 300, 300)) {
                        shootx = persik.x;
                        shooty = persik.y;
                        draw_arb = true;
                    }
                    if (hit(screenX, h - screenY, w / ax + 112, h / ay + 112, 50, 60) & hit(persik.x, persik.y, big_ejx, big_ejy, 300, 300)) {
                        shootx = persik.x;
                        shooty = persik.y;
                        draw_arb = true;
                    }
                ...
                for (int i = 0; i < magx.length; i += 1) {
                    if (hit(screenX, h - screenY, w / ax + 112, h / ay + 112, 50, 60) & hit(persik.x, persik.y, magx[i], magy[i], 300, 300)) {
                        shootx = persik.x;
                        shooty = persik.y;
                        draw_arb = true;
                    }
                ...
                for (int i = 0; i < gribx.length; i += 1) {
                    if (hit(screenX, h - screenY, korobkax + 112, korobkay + 112, 50, 60)) {
                        state_korobka = 10;
                        if (hit(persik.x, persik.y, gribx[i], griby[i], 50, 150)) {
                        ...
                        if (hit(persik.x, persik.y, enemyx[i], enemyy[i], 50, 150)) {
                        ...
                        if (hit(persik.x, persik.y, zelx, zely, 500, 1500)) {
                        ...
                        if (hit(persik.x, persik.y, syppx, syppy, 50, 150)) {
                        ...
                        if (hit(persik.x, persik.y, sypx, sypy, 50, 150)) {
        ...
        Thread math = new Thread() {
            ...
            public void run() {
                while (true) {
                    ...
                    persik.y += persik.sy;
                    persik.xz += persik.sz;
                    persik.sx += (-persik.sx) / persik.speed;
                    persik.sy += (-persik.sy) / persik.speed;
                    persik.sz += (-5 - persik.sz) / persik.speed - 1;
                    if (persik.xz < 0) {
                        persik.xz = 0;
                        persik.sz = persik.sz / -2;
                    }
                    ...
                    for (int i = persik.tx.length - 1; i > 0; i -= 1) {
                        persik.tx[i] = persik.tx[i - 1];
                        persik.ty[i] = persik.ty[i - 1];
                        persik.tz[i] = persik.tz[i - 1];
                        persik.ts[i] = persik.ts[i - 1];
                        if (persik.tz[i] > 1) {
                            persik.tz[i] -= 0.5f;
                        }
                    }
                    persik.tx[0] = persik.x;
                    persik.ty[0] = persik.y;
                    persik.tz[0] = persik.xz;
                    if (agr >= 1) {
                        persik.ts[0] = agr * 2;
                    } else {
                        persik.ts[0] = 0;
                    ...
                    for (int i = 0; i < ejx.length; i += 1) {
                        if (hit(persik.x, persik.y, big_ejx, big_ejy, 50, 50)) {
                            hps[11] = 0;
                        }
                    ...
                    if (hit(fireballx, firebally, persik.x, persik.y, 20, 20)) {
                        chet = 1;
                        sound0.play(1.0f);
                    }
                    for (int i = 0; i < ejx.length; i += 1) {
                        if (hit(persik.x, persik.y, ejx[i], ejy[i], 50, 50)) {
                            ejx[i] = 9999999;
                            ejy[i] = 9999999;
                            sound0.play(1.0f);
                            int i3 = 9;
                    ...
                    for (int i = 0; i < ejx.length; i += 1) {
                        ...
                        //if (hit2(persik.x, persik.y, ejx[i], ejy[i]) >= 500) {
                        //    if (kryg1 >= 50 * ejx.length) {
                        //        kryg4 = 0;
                        //        ejx[i] += 5 + random.nextInt(3) - 1;
                        //        ejy[i] -= 5 + random.nextInt(3) - 1;
                        //        kryg2 += 1;
                        //        ejn[i] = 1;
                        //    }
                        //    if (kryg2 >= 50 * ejx.length) {
                        //        kryg1 = 0;
                        //        ejx[i] -= 5 + random.nextInt(3) - 1;
                        //        ejy[i] -= 5 + random.nextInt(3) - 1;
                        //        kryg3 += 1;
                    ...
                    for (int i = 0; i < magx.length; i += 1) {
                        if (hit2(persik.x, persik.y, magx[i], magy[i]) >= 700) {
                            if (magx[i] > kraftx) {
                        ...
                        if (hit2(persik.x, persik.y, magx[i], magy[i]) <= 700 & shar == 1) {
                            if (chet_fireball == 1) {
                                if (magd[i] == 0) {
                                    magd[i] = 1;
                                }
                            ...
                            if (fireballx > persik.x) {
                                fireballx -= 5 + random.nextInt(3) - 1;
                            }
                            if (fireballx < persik.x) {
                                fireballx += 5 + random.nextInt(3) - 1;
                            }
                            if (firebally > persik.y) { //// следование fireballa за персиком
                                firebally -= 5 + random.nextInt(3) - 1;
                            }
                            if (firebally < persik.y) {
                                firebally += 5 + random.nextInt(3) - 1;
                            }
                        }
                        if (hit2(persik.x, persik.y, fireballx, firebally) >= 600) {
                            fireballx = 9999;
                            firebally = 9999;
                            chet_fireball = 1;
                        }
                        if (hit(persik.x, persik.y, fireballx, firebally, 30, 30)) {
                            int i3 = 9;
                            for (int i2 = 9; i2 > 4; ) {
                                if (hps[i3] == 1) {
                                    hps[i3] = 0;
    ...
    public void render() {
        ...
        sytki += 1;
        if (big_ej >= 5) {
            Gdx.app.log("", "big_ej tyt");
            if (chet_big_ej == 1) {
                big_ejx = persik.x + 200;
                big_ejy = persik.y + 200;
                chet_big_ej = 0;
                Gdx.app.log("", "big_ej tyt2");
            }
            if (big_ejx > persik.x) {
                big_ejx -= 2;
            }
            ...
            if (big_ejy > persik.y) { //// следование биг ежа за персиком
                big_ejy -= 2;
            }
            if (big_ejy < persik.y) {
                big_ejy += 2;
        ...
        batch.draw(shadow, -cx + persik.x, -cy + persik.y, persik.w, persik.h);
        ...
        for (int i = 0; i < 20; i += 1) {
            if (dashs[i] != 0) {
                ...
                batch.draw(dash[(int) dashs[i]], -cx + dashx[i] - dashz[i] / 8 - m / 2, -cy + dashy[i] - dashz[i] / 8 - m / 2 + dashz[i], persik.w + dashz[i] / 4 + m, persik.h + dashz[i] / 4 + m);
        ...
        for (int i = persik.tx.length - 1; i > 0; i -= 1) {
            if (persik.ts[i] >= 1) {
                batch.draw(poop, -cx + persik.tx[i] - persik.tz[i] / 8 + 50, -cy + persik.ty[i] + persik.tz[i] - persik.tz[i] / 8 + 50, persik.tz[i] / 4 + 20 * persik.ts[i] + 10, persik.tz[i] / 4 + 20 * persik.ts[i] + 10);
            }
        }


        batch.draw(img, -cx + persik.x - persik.xz / 8, -cy + persik.y + persik.xz - persik.xz / 8, persik.w + persik.xz / 4, persik.h + persik.xz / 4);
        batch.setColor(1, 1, 1, 1);
